                    ...
                    switch (page){
                        ...
                        case this.go_to_page :
                            ...
                            if( this.go_to_page != '' && this.go_to_page <= parseInt(this.last_page)){
                                ...
                                getPage = 'api/widget-vue?page=' + this.go_to_page + '&column=' + this.sortKey + '&direction=' + this.sortOrder;
                        ...
                        default :
                            ...
                            getPage = 'api/widget-vue?page=' + page + '&column=' + this.sortKey + '&direction=' + this.sortOrder;
