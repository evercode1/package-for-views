    ...
    <script type="text/x-template" id="grid-template">
        <div class="row">
            ...
            <tr v-for="row in data">
                ...
                <td>
                    <a href="/gadget/@{{row.Id}}">@{{row.Name}}</a>
                </td>
                <td>@{{ row.Widget }}</td>
                <td>
                    @{{row.Created | formatDate}}
                </td>
                <td ><a href="/gadget/@{{row.Id}}/edit"> <button type="button" class="btn btn-default">Edit</button></a></td>
            </tr>
            </tbody>
        </table>
                    </div>
...
@section('scripts')
    ...
    <script>
                ...
                getData: function (page) {
                    ...
                    switch (page){
                        ...
                        case this.last_page_url :
                            ...
                            getPage = 'api/gadget-vue?keyword=' + this.query + '&column=' + this.sortKey + '&direction=' + this.sortOrder;
                        ...
                        case this.go_to_page :
                            ...
                            if( this.go_to_page != '' && this.go_to_page <= parseInt(this.last_page)){
                                ...
                                getPage = 'api/gadget-vue?page=' + this.go_to_page + '&column=' + this.sortKey + '&direction=' + this.sortOrder + '&keyword=' + this.query;
                        ...
                        default :
                            ...
                            getPage = 'api/gadget-vue?page=' + page + '&column=' + this.sortKey + '&direction=' + this.sortOrder + '&keyword=' + this.query;
                    ...
                    if (this.query == '' && getPage != null){
                        ...
                        if (getPage != null){
                            ...
                            this.first_page_url = 'api/gadget-vue?page=1&keyword=' +this.query;
                            this.last_page_url = 'api/gadget-vue?page=' + this.last_page + '&keyword=' +this.query;
                            this.current_page = data.current_page;
        ...
        var gadget = new Vue({
            ...
            data: {
                query: '',
                gridColumns: ['Id', 'Name', 'Widget', 'Created'],
                gridData: [],
                total: null,
                next_page_url: null,
                prev_page_url: null,
            ...
            components: 'gadget-grid',

            methods: {
                loadData: function () {
                    $.getJSON('api/gadget-vue', function (data) {
                        ...
                        this.prev_page_url = data.prev_page_url;
                        this.current_page = data.current_page;
                        this.first_page_url = 'api/gadget-vue?page=1';
                        this.last_page_url = 'api/gadget-vue?page=' + this.last_page;
                        this.setPageNumbers();
                    }.bind(this));
                },
