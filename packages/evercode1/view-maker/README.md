...
To do list:
1.  create templates
2. format model name, if someone uses dash in folder name
3.  docs to include screenshots
4.  write tutorial for use with datatables
5.  create repository on git hub
6.  create package on packagist
7.  Update book
8.  launch on blogs
